...
async def handle_block_click(websocket, agent):
    ...
    """
    try:
        # Send status update to client indicating protoblock creation has started
        await websocket.send(json.dumps({
            "type": "status_update",
            "message": "creating protoblock"
        }))
